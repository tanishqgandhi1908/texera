...
import { ModelVariablesEditorComponent } from "../../workspace/component/model-variables-editor/model-variables-editor.component";
...
export const TEXERA_FORMLY_CONFIG = {
  ...
  types: [
    ...
    { name: "modelvariables", component: ModelVariablesEditorComponent, wrappers: ["form-field"] },
