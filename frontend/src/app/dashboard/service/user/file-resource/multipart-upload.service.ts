...
/**
 * The multipart upload engine, shared by every versioned resource kind. Addressing is supplied by
 * the caller via FileResourceEndpoint; everything else is resource-agnostic.
 */
@Injectable({
  providedIn: "root",
})
