...
export class SearchComponent implements AfterViewInit {
  ...
  selectedType: "project" | "workflow" | "dataset" | "model" | null = null;
  lastSelectedType: "project" | "workflow" | "dataset" | "model" | null = null;
  ...
  filterByType(type: "project" | "workflow" | "dataset" | "model" | null): void {
