...
case class WorkerConfig(
    ...
    // Model versions to make readable to the Python worker: variable name -> locator
    // "<repositoryName>:<commitHash>". Each is ensured mounted before the Python process
    // starts; empty means no mounts.
